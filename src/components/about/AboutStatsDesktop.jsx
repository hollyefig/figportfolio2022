...
export default function AboutStatsDesktop({
  radius,
  circleMobile,
  cxcy,
  aboutVisible,
  ...
  return (
    <>
      <div className='aboutDesignWrapper'>
      ...
      {/* wed dev skills section  */}
      <div className='aboutDevWrapper'>
          ...
          <div className='htmlSkillWrapper'>
            ...
            >
              ...
              <circle
                ...
                r={radius}
                stroke-linecap='round'
                className={aboutVisible ? "htmlHpTransition" : "htmlHpStart"}
              />
            </svg>
          </div>
          {/* css skill  */}
          <div className='cssSkillWrapper'>
            ...
            >
              ...
              <circle
                ...
                r={radius}
                stroke-linecap='round'
                className={aboutVisible ? "cssHpTransition" : "cssHpStart"}
              />
            </svg>
          </div>
        </div>
